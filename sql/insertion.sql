...
values (1, "Châteaux", "/site_web/public/img/chateaux/bois/image2.jpeg", "france",
...
(1, '/site_web/public/img/chateaux/bois/image1.jpeg', 1, "horizontal"),
(1, '/site_web/public/img/chateaux/bois/image2.jpeg', 2, "horizontal"),
(1, '/site_web/public/img/chateaux/bois/image3.jpeg', 3, "horizontal"),

(2, '/site_web/public/img/chateaux/bois/image4.jpeg', 1, "vertical"),
(2, '/site_web/public/img/chateaux/bois/image5.jpeg', 2, "horizontal"),
(2, '/site_web/public/img/chateaux/bois/image6.jpeg', 3, "horizontal"),
(2, '/site_web/public/img/chateaux/bois/image7.jpeg', 4, "horizontal"),
(2, '/site_web/public/img/chateaux/bois/image8.jpeg', 5, "horizontal"),
(2, '/site_web/public/img/chateaux/bois/image9.jpeg', 6, "horizontal"),

(3, '/site_web/public/img/chateaux/bois/image10.jpeg', 1, "vertical"),
(3, '/site_web/public/img/chateaux/bois/image11.jpeg', 2, "vertical"),
(3, '/site_web/public/img/chateaux/bois/image12.jpeg', 3, "vertical");
...
insert into DESCRIPTIFLIEUX (idL, nom_categorie, chemin_img_banniere, pays, histoire_lieux)
values (2, "Châteaux", "/site_web/public/img/chateaux/douves/image1.jpeg", "france",
...
insert into IMAGEGALLERIE (idG, chemin, ordreImg, cadrage) values
(4, '/site_web/public/img/chateaux/douves/image1.jpeg', 1, "horizontal"),
(4, '/site_web/public/img/chateaux/douves/image2.jpeg', 2, "horizontal"),
(4, '/site_web/public/img/chateaux/douves/image3.jpeg', 3, "horizontal"),
(4, '/site_web/public/img/chateaux/douves/image4.jpeg', 4, "horizontal"),
(4, '/site_web/public/img/chateaux/douves/image5.jpeg', 5, "vertical"),
(4, '/site_web/public/img/chateaux/douves/image6.jpeg', 6, "horizontal"),

(5, '/site_web/public/img/chateaux/douves/image7.jpeg', 1, "vertical"),
(5, '/site_web/public/img/chateaux/douves/image8.jpeg', 2, "horizontal"),
(5, '/site_web/public/img/chateaux/douves/image9.jpeg', 3, "horizontal");
...
insert into DESCRIPTIFLIEUX (idL, nom_categorie, chemin_img_banniere, pays, histoire_lieux)
values (3, "Châteaux", "/site_web/public/img/chateaux/colimacon/image1.jpeg", "france", 
...
insert into IMAGEGALLERIE (idG, chemin, ordreImg, cadrage) values 
(6, '/site_web/public/img/chateaux/colimacon/image1.jpeg', 1, "horizontal"),
(6, '/site_web/public/img/chateaux/colimacon/image2.jpeg', 2, "vertical"),
(6, '/site_web/public/img/chateaux/colimacon/image3.jpeg', 3, "horizontal"),

(7, '/site_web/public/img/chateaux/colimacon/image4.jpeg', 1, "horizontal"),
(7, '/site_web/public/img/chateaux/colimacon/image5.jpeg', 2, "vertical"),
(7, '/site_web/public/img/chateaux/colimacon/image6.jpeg', 3, "vertical"),
(7, '/site_web/public/img/chateaux/colimacon/image7.jpeg', 4, "vertical"),
(7, '/site_web/public/img/chateaux/colimacon/image8.jpeg', 5, "vertical"),
(7, '/site_web/public/img/chateaux/colimacon/image9.jpeg', 6, "horizontal"),

(8, '/site_web/public/img/chateaux/colimacon/image10.jpeg', 1, "vertical"),
(8, '/site_web/public/img/chateaux/colimacon/image11.jpeg', 2, "horizontal"),
(8, '/site_web/public/img/chateaux/colimacon/image12.jpeg', 3, "vertical"),
(8, '/site_web/public/img/chateaux/colimacon/image13.jpeg', 4, "horizontal"),
(8, '/site_web/public/img/chateaux/colimacon/image14.jpeg', 5, "horizontal");
...
insert into DESCRIPTIFLIEUX (idL, nom_categorie, chemin_img_banniere, pays, histoire_lieux)
values (4, "Châteaux", "/site_web/public/img/chateaux/fruminet/image1.jpeg", "france",
...
insert into IMAGEGALLERIE (idG, chemin, ordreImg, cadrage) values
(9, '/site_web/public/img/chateaux/fruminet/image1.jpeg', 1, "horizontal"),
(9, '/site_web/public/img/chateaux/fruminet/image2.jpeg', 2, "vertical"),
(9, '/site_web/public/img/chateaux/fruminet/image3.jpeg', 3, "horizontal"),

(10, '/site_web/public/img/chateaux/fruminet/image4.jpeg', 1, "vertical"),
(10, '/site_web/public/img/chateaux/fruminet/image5.jpeg', 2, "horizontal"),
(10, '/site_web/public/img/chateaux/fruminet/image6.jpeg', 3, "horizontal"),

(11, '/site_web/public/img/chateaux/fruminet/image7.jpeg', 1, "horizontal"),
(11, '/site_web/public/img/chateaux/fruminet/image8.jpeg', 2, "horizontal"),
(11, '/site_web/public/img/chateaux/fruminet/image9.jpeg', 3, "vertical");

insert into PARAGRAPHE (idG, paragraphe) values
(9, "Situé dans une petite forêt en bordure de ville, le squelette de l’édifice est désormais enveloppé par une végétation qui a repris ses droits autour de la bâtisse. Malheureusement, lors de mon passage, la marquise qui surplombait l’entrée s’était effondrée."),
(10, "À l’intérieur, toutes les pièces sont désertes. Un vaste couloir parcourt toute la longueur du château et donne accès à plusieurs salles, dont la plus remarquable se situe juste en face de l’entrée principale. Des ornements subsistent sur les murs et le plafond, mêlés au délabré et aux graffitis, ce qui rend la pièce encore majestueuse."),
(11, "Quelques autres pièces méritent également d’être vues. Enfin, on y trouve un escalier menant aux étages, qui, à cause de l’incendie, n’est plus praticable.");
...
insert into LIEUX (nom_categorie, slug, nom, date_explo) 
values ("Châteaux", "riviere", "Le Château de la Rivière", "2024-05-15");

insert into DESCRIPTIFLIEUX (idL, nom_categorie, chemin_img_banniere, pays, histoire_lieux)
values (5, "Châteaux", "/site_web/public/img/chateaux/riviere/image1.jpeg", "france",
"Construit au XVIIe siècle sur les bords d’une rivière, ce château a été laissé à l’abandon après la Révolution française. Ses jardins autrefois majestueux sont maintenant envahis par la végétation. Le bâtiment principal, malgré des parties effondrées, conserve ses belles façades et ses tours caractéristiques.");

insert into GALLERIE (idL, nom_categorie) values (5, 'Châteaux');
insert into GALLERIE (idL, nom_categorie) values (5, 'Châteaux');

insert into IMAGEGALLERIE (idG, chemin, ordreImg, cadrage) values
(12, '/site_web/public/img/chateaux/riviere/image1.jpeg', 1, "horizontal"),
(12, '/site_web/public/img/chateaux/riviere/image2.jpeg', 2, "vertical"),
(13, '/site_web/public/img/chateaux/riviere/image3.jpeg', 1, "horizontal"),
(13, '/site_web/public/img/chateaux/riviere/image4.jpeg', 2, "horizontal");

insert into PARAGRAPHE (idG, paragraphe) values
(12, "L’extérieur du château montre des murs recouverts de lierre et de végétation. Les tours sont encore intactes mais nécessitent une restauration."),
(13, "À l’intérieur, les sols sont partiellement effondrés et seules quelques pièces conservent des vestiges de décorations anciennes.");

insert into STRUCTURE (idL, nom_categorie, ordre_structure, types, ref) VALUES
(5, 'Châteaux', 1, 'paragraphe', 12),
(5, 'Châteaux', 2, 'galerie', 12),
(5, 'Châteaux', 3, 'paragraphe', 13),
(5, 'Châteaux', 4, 'galerie', 13);


-- Usine abandonnée de Montfermeil --
insert into LIEUX (nom_categorie, slug, nom, date_explo)
values ("Usines", "montfermeil", "Usine abandonnée de Montfermeil", "2023-11-20");

insert into DESCRIPTIFLIEUX (idL, nom_categorie, chemin_img_banniere, pays, histoire_lieux)
values (1, "Usines", "/site_web/public/img/usines/montfermeil/image1.jpeg", "france",
"Cette ancienne usine textile a été fermée dans les années 1980. Les machines ont été retirées et le bâtiment est maintenant envahi par la végétation. Les murs extérieurs montrent encore des traces de peintures industrielles et d’anciennes affiches publicitaires.");

insert into GALLERIE (idL, nom_categorie) values (1, 'Usines');

insert into IMAGEGALLERIE (idG, chemin, ordreImg, cadrage) values
(14, '/site_web/public/img/usines/montfermeil/image1.jpeg', 1, "horizontal"),
(14, '/site_web/public/img/usines/montfermeil/image2.jpeg', 2, "vertical"),
(14, '/site_web/public/img/usines/montfermeil/image3.jpeg', 3, "horizontal");

insert into PARAGRAPHE (idG, paragraphe) values
(14, "Le hall principal est immense mais complètement vide. On peut apercevoir des traces d’anciennes installations électriques et des conduits d’aération rouillés.");

insert into STRUCTURE (idL, nom_categorie, ordre_structure, types, ref) VALUES
(1, 'Usines', 1, 'paragraphe', 14),
(1, 'Usines', 2, 'galerie', 14);
